    ...
    static async determineMediaInfo(filePath, fileType) {
        ...
        if (fileType == "series") {
            ...
            if (parsedEpisode && parsedEpisode.show && parsedEpisode.season && parsedEpisode.episode) {
                logger.log("parsedEpisode", parsedEpisode);
            ...
            if (anitomyParse && anitomyParse.anime_title && anitomyParse.episode_number) {
                logger.log("anitomyParse", anitomyParse);
            ...
            if (
                ...
                logger.log("parseTorrentName", parseTorrentName);
        ...
        logger.log("failed to determine media data", filePath, parsedPath, fileType);
        return null;
    }
}
